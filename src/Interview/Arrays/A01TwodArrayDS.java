...
public class A01TwodArrayDS {
    ...
    private static int sumHourglass(int[][] arr, int rS, int cS){
        return arr[rS][cS] + arr[rS][cS+1] + arr[rS][cS+2] + 
                arr[rS+1][cS+1] +
                arr[rS+2][cS] + arr[rS+2][cS+1] + arr[rS+2][cS+2]; 
    }
    ...
    public static void main(String[] args){
        ...
        int re1 = hourglassSum(arr1);
        System.out.printf("Expected: 28, result: %d", re1);
    }
}
